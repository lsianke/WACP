...
class Inception(nn.Module):
    def __init__(self, in_planes, n1x1, n3x3red, n3x3, n5x5red, n5x5, pool_planes,tmp_name, compress_rate, last=False):
        ...
        if self.n5x5 > 0:
            ...
            conv5x5_2 = nn.Conv2d(n5x5red, math.ceil(n5x5*(1.-compress_rate[1])), kernel_size=3, padding=1)
            conv5x5_3 = nn.Conv2d(math.ceil(n5x5*(1.-compress_rate[1])), output, kernel_size=3, padding=1)
            ...
            self.branch5x5 = nn.Sequential(
                ...
                nn.ReLU(True),
                conv5x5_2,
                nn.BatchNorm2d(math.ceil(n5x5*(1.-compress_rate[1]))),
                nn.ReLU(True),
                conv5x5_3,
                nn.BatchNorm2d(output),
                nn.ReLU(True),
