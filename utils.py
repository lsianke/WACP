...
def load_cifar10_demo(data_name = 'CIFAR10', data_dir = './data', batch_size = 128, num_workers = 1,pin_memory = True,scale_size = 32):
	valdir = os.path.join(data_dir, 'cifar-10-demo')
